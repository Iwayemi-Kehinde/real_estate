  ...
  return (
    <header className="border-bottom z-20 bg-white px-[2%] flex justify-between items-center py-[20px]">
      ...
      <ul className="list-none hidden xl:block">
        <Link to={"/"}>
          <li className="inline-block m-4 hover:text-blue-500 transition-all">Home</li>
        </Link>
        <Link to={"/about"}>
          <li className="inline-block m-4 hover:text-blue-500 transition-all">About</li>
        </Link>
        <Link to={"/services"}>
          <li className="inline-block m-4 hover:text-blue-500 transition-all">Services</li>
        </Link>
        <Link to="/contact">
          <li className="inline-block m-4 hover:text-blue-500 transition-all">Contact</li>
        </Link>
        
        <li className="inline-block text-white bg-blue-500 ml-4 px-4 py-2 rounded-[4px] cursor-pointer hover:bg-blue-400 transition-all">Get Started <FaRightToBracket className=" align-middle mt-[-4px] ml-1"/> </li>
      </ul>
    </header>
  );
};
